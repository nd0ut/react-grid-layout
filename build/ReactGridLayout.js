...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.onDrag = function onDrag(i /*:string*/, x /*:number*/, y /*:number*/, _ref2) {
    ...
    this.setState({
      layout: (0, _utils.compact)(layout, this.props.verticalCompact, this.props.compactItem),
  ...
  ReactGridLayout.prototype.onResize = function onResize(i /*:string*/, w /*:number*/, h /*:number*/, _ref5) {
    ...
    this.setState({ layout: (0, _utils.compact)(layout, this.props.verticalCompact, this.props.compactItem), activeDrag: placeholder });
  };
